...
SpaceHipster.GameState = {
  ...
  //   // this.texto = this.add.text(this.game.world.centerX, this.game.world.height - 50, "Score :"+ count, {
  //    font: "10px Arial",
  //     fill: "#ff0044",
  //     align: "center"
  //  });
  ...
  damageEnemy: function(bullet, enemy) {
    ...
    bullet.kill();
  // this.count++;
   // this.texto.setText('Score:' + this.count);
  },
